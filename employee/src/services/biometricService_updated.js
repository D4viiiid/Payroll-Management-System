...
class BiometricService {
  ...
  async biometricLogin() {
    const response = await axios.post(`${BIOMETRIC_API}/login`);
    return response.data;
  }

  async biometricLoginIPC() {
    const response = await axios.post(`${BIOMETRIC_API}/login`);
    return response.data;
  }
}
...
export const biometricLogin = () => biometricService.biometricLogin();
export const biometricLoginIPC = () => biometricService.biometricLoginIPC();
